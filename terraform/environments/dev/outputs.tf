...
output "database_subnet_ids" {
  description = "Database subnets for development."
...
output "cluster_certificate_authority_data" {
  description = "Development EKS cluster certificate authority data."
...
output "rds_endpoint" {
  description = "PostgreSQL endpoint for development."
...
output "redis_primary_endpoint" {
  description = "Primary Redis endpoint for development."
...
output "loki_bucket_name" {
  description = "S3 bucket used by Loki in development."
  value       = module.observability_irsa.loki_bucket_name
}

output "irsa_role_arns" {
  description = "IRSA role ARNs for the development cluster."
  value = {
